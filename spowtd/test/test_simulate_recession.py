...
def test_simulate_recession_curve(
    ...
    expected_curve = {
        ('peatclsm', 388):
        [0.54318592,  6.22354904, 11.04775281, 15.14873985, 18.69618036,
         21.86714916, 24.82033685, 27.68090068, 30.53555132, 33.436654],
        ('spline', 388):
        [10.20150277, 12.76083539, 14.84755905, 16.70785659, 18.49795906,
         20.26995933, 21.9681307, 23.46717728, 24.91539903, 26.36362078],
        ('peatclsm', 287):
        [0.54318592,  6.22354904, 11.04775281, 15.14873985, 18.69618036,
         21.86714916, 24.82033685, 27.68090068, 30.53555132, 33.436654],
        ('spline', 287):
    ...
    recession_curve = simulate_recession_mod.compute_recession_curve(
        ...
        et_mm_d=et_mm_d)
    assert np.allclose(recession_curve.mean(),
                       mean_elapsed_time_d)
