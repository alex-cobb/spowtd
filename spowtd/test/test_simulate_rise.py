...
@pytest.mark.parametrize(
    ...
    [
        ('peatclsm', [
            -137.02531183, -103.31683955, -70.68835402, -39.36074849,
            -9.61918877, 18.38953548, 45.56722828, 75.67822728,
            116.09909334, 174.27635828]),
        ('spline', [
            -58.42252048, -44.61618714, -30.80985381, -17.00352048,
            -3.19718714, 10.60914619, 24.84092401, 41.60896966,
            60.02310417, 86.96712502])
    ])
def test_compute_rise_curve(sy_type, expected_curve):
    ...
    """
    with open(
            conftest.get_parameter_file_path(sy_type),
            'rt') as sy_file:
