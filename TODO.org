 ...
 - [ ] Design UI to create PEST files from data db for calibration
   against: rise curve, rise and recession curves, rise and recession
   intervals:
   - spowtd pestfiles rise / curves / intervals
     - Then args for the different file types --- because you can
       write more than one if you want, why not?
     - Could have an optional YAML argument with configuration
       for PEST
